			...
			<div id="contenido"  class="card">
			    <div class="tabs-container">
			        <ul class="nav nav-tabs user-tabs">
			            <li class="active">
			            	<a data-toggle="tab" href="#tab-1-active"> <i class="fa fa-users"></i>Active posts</a>
			            </li>
			            <li class="">
			            	<a data-toggle="tab" href="#tab-2-inactive"><i class="fa fa-ban"></i>Inactive posts</a>
			            </li>
			            <li class="">
									...
									<table class="table table-striped table-hover">
								         ...
								         <tbody>
							         		@foreach ($all_ as $channel)
							                	...
							                	<tr>
							                		<td>
														<a href="{{route('posts.show', $channel->slug)}}">
											               	<figure>
									               ...
									               <td>
									               		<a type="button" class="col-md-6 btn btn-secondary" href="{{route('posts.edit', $channel->slug)}}">Edit</a>
										            	<div class="col-md-6">
											            	{!! Form::open(['route' => ['posts.destroy', $channel->slug], 'method' => 'DELETE']) !!}
